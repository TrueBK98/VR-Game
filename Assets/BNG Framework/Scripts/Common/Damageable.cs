...
namespace BNG {
    ...
    {
        public static SerializableDictionary<string, bool> damageableDestroyed = new SerializableDictionary<string, bool>();
        ...
        public virtual void DestroyThis() {
            ...
            {
                if (Damageable.damageableDestroyed.ContainsKey(id))
                {
                    Damageable.damageableDestroyed.Remove(id);
                }
                Damageable.damageableDestroyed.Add(id, destroyed);
            }
        ...
        {
            GlobalVar.damageableDestroyed = GameData.Instance.damageableDestroyed;
            GlobalVar.damageableDestroyed.TryGetValue(id, out destroyed);
            try
            {
        ...
        {
            if (GlobalVar.damageableDestroyed.ContainsKey(id))
            {
                GlobalVar.damageableDestroyed.Remove(id);
            }
            GlobalVar.damageableDestroyed.Add(id, destroyed);
            GameData.Instance.damageableDestroyed = GlobalVar.damageableDestroyed;
        }
    }
}